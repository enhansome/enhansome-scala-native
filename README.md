...
* [Giter8 template for a minimal Scala Native project](https://github.com/scala-native/scala-native.g8) ⭐ 80 | 🐛 5 | 🌐 Scala | 📅 2026-07-06 - Official [Giter8](http://www.foundweekends.org/giter8/) template for a minimal Scala Native project.
...
* [Building C code using sbt-jni](https://github.com/nadavwr/scala-native-sbt-jni-example) ⭐ 6 | 🐛 0 | 🌐 CMake | 📅 2017-05-19 - Example for compiling C code in a Scala Native project using [sbt-jni](https://github.com/jodersky/sbt-jni) ⭐ 136 | 🐛 6 | 🌐 Scala | 📅 2026-08-09.
...
* [Mill](https://github.com/com-lihaoyi/mill) ⭐ 2,777 | 🐛 253 | 🌐 Scala | 📅 2026-08-13 - Build tool striving for simplicity, inspired by [Bazel](https://www.bazel.build/).
* [Bloop](https://github.com/scalacenter/bloop) ⭐ 942 | 🐛 67 | 🌐 Scala | 📅 2026-08-12 - Scala build server and command-line tool for fast developer workflows.
* [Seed](https://github.com/tindzk/seed) ⭐ 238 | 🐛 24 | 🌐 Scala | 📅 2020-12-11 - Build tool based on Bloop. Focuses on user experience and cross-platform builds, inspired by [Cargo](https://github.com/rust-lang/cargo) ⭐ 15,383 | 🐛 1,657 | 🌐 Rust | 📅 2026-08-14.
* [sbt](https://www.scala-sbt.org/) - Scala's standard build tool.

## Functional Programming

* [Cats](https://github.com/typelevel/cats) ⭐ 5,451 | 🐛 282 | 🌐 Scala | 📅 2026-08-09 - Abstractions for functional programming in Scala.
* [scalaz](https://github.com/scalaz/scalaz) ⭐ 4,673 | 🐛 154 | 🌐 Scala | 📅 2026-08-10 - Type classes and instances for data structures.
* [Shapeless](https://github.com/milessabin/shapeless) ⭐ 3,399 | 🐛 29 | 🌐 Scala | 📅 2026-08-13 - Library for generic programming.
* [chimney](https://github.com/scalalandio/chimney) ⭐ 1,254 | 🐛 8 | 🌐 Scala | 📅 2026-08-13 - Boilerplate-free data transformations.
...
* [reactify](https://github.com/outr/reactify) ⭐ 93 | 🐛 8 | 🌐 Scala | 📅 2026-08-09 - Functional Reactive Programming framework for Scala.
* [nobox](https://github.com/xuwei-k/nobox) ⭐ 33 | 🐛 0 | 🌐 Scala | 📅 2026-08-07 - Immutable primitive array wrapper without boxing.

## Unit Tests

* [ScalaCheck](https://github.com/typelevel/scalacheck) ⭐ 1,964 | 🐛 66 | 🌐 Scala | 📅 2026-08-10 - Property-based testing for Scala.
* [ScalaTest](https://github.com/scalatest/scalatest) ⭐ 1,167 | 🐛 548 | 🌐 Scala | 📅 2026-08-14 - Testing library.
* [specs2](https://github.com/etorreborre/specs2) ⭐ 734 | 🐛 0 | 🌐 Scala | 📅 2026-08-13 - Software Specifications for Scala.
* [µTest](https://github.com/lihaoyi/utest) ⭐ 507 | 🐛 21 | 🌐 Scala | 📅 2026-01-22 - Library for unit tests.
* [MUnit](https://github.com/scalameta/munit) ⭐ 472 | 🐛 42 | 🌐 Scala | 📅 2026-08-09 - Scala testing library with actionable errors and extensible APIs.
* [scalaprops](https://github.com/scalaprops/scalaprops) ⭐ 282 | 🐛 10 | 🌐 Scala | 📅 2026-08-07 - Library for property-based testing.
  * [scalaprops-shapeless](https://github.com/scalaprops/scalaprops-shapeless) ⭐ 10 | 🐛 2 | 🌐 Scala | 📅 2026-08-07 - Generation of arbitrary ADT instances.
  * [scalaprops-cross-example](https://github.com/scalaprops/scalaprops-cross-example) ⭐ 4 | 🐛 0 | 🌐 Scala | 📅 2026-08-07 - Cross-platform example.
* [minitest](https://github.com/monix/minitest) ⭐ 182 | 🐛 21 | 🌐 Scala | 📅 2026-08-10 - Lightweight testing library.
* [Makeshift](https://github.com/nadavwr/makeshift) ⭐ 1 | 🐛 0 | 🌐 Scala | 📅 2018-03-10 - Library for unit tests.

## Bindings

* [libui](https://github.com/lolgab/scalaui) ⭐ 75 | 🐛 0 | 🌐 Scala | 📅 2024-07-18 - GUI framework based on [libui](https://github.com/andlabs/libui) ⭐ 10,893 | 🐛 249 | 🌐 C | 📅 2024-05-29.
...
* [BLAS](https://github.com/ekrich/sblas) ⭐ 37 | 🐛 4 | 🌐 Scala | 📅 2026-08-11 - Bindings for [BLAS](http://www.netlib.org/blas/), a library for Linear Algebra.
...
* [cmark](https://github.com/sparsetech/cmark-scala) ⭐ 16 | 🐛 0 | 🌐 Scala | 📅 2021-09-14 - Bindings for the [cmark](https://github.com/commonmark/cmark) ⭐ 2,014 | 🐛 76 | 🌐 C | 📅 2026-08-12 CommonMark parser library.
* [libuv](https://github.com/TimothyKlim/scala-native-libuv) ⭐ 10 | 🐛 0 | 🌐 Scala | 📅 2017-04-29 - Bindings for [libuv](https://github.com/libuv/libuv) ⭐ 27,096 | 🐛 225 | 🌐 C | 📅 2026-08-06, a library for asynchronous I/O.
...
* [ScalaPB](https://github.com/scalapb/ScalaPB) ⭐ 1,338 | 🐛 63 | 🌐 Scala | 📅 2026-08-07 - [Protocol Buffer](https://developers.google.com/protocol-buffers/) compiler for Scala.
  * [scalapb-argonaut](https://github.com/scalapb-json/scalapb-argonaut) ⭐ 2 | 🐛 1 | 🌐 Scala | 📅 2026-08-12 - JSON and Protocol Buffer converters for ScalaPB based on [Argonaut](http://argonaut.io).
* [FastParse](https://github.com/com-lihaoyi/fastparse) ⭐ 1,135 | 🐛 23 | 🌐 Scala | 📅 2026-01-14 - Library for defining and running parsers.
* [scalatags](https://github.com/com-lihaoyi/scalatags) ⭐ 773 | 🐛 40 | 🌐 Scala | 📅 2025-07-11 - HTML/XML construction and rendering.
...
* [argonaut](https://github.com/argonaut-io/argonaut) ⭐ 544 | 🐛 26 | 🌐 Scala | 📅 2026-08-10 - Purely functional JSON parser and library.
* [sconfig](https://github.com/ekrich/sconfig) ⭐ 135 | 🐛 15 | 🌐 Scala | 📅 2026-08-11 - [HOCON](https://github.com/ekrich/sconfig/blob/master/docs/original/HOCON.md) ⭐ 135 | 🐛 15 | 🌐 Scala | 📅 2026-08-11 parser.
...
* [toml-scala](https://github.com/sparsetech/toml-scala) ⚠️ Archived - [TOML](https://github.com/toml-lang/toml) ⭐ 20,565 | 🐛 15 | 📅 2026-07-03 parser with codec derivation.
* [msgpack4z](https://github.com/msgpack4z/msgpack4z-native) ⭐ 5 | 🐛 1 | 🌐 Scala | 📅 2026-08-07 - Implementation of [MessagePack](https://msgpack.org/), a binary serialisation format.
...
* [skunk](https://github.com/typelevel/skunk) ⭐ 1,664 | 🐛 93 | 🌐 Scala | 📅 2026-08-09 -  A data access library for Scala + Postgres.
...
* [sttp](https://github.com/softwaremill/sttp) ⭐ 1,503 | 🐛 26 | 🌐 Scala | 📅 2026-08-14 - HTTP Client library.
...
* [scala-native-loop](https://github.com/scala-native/scala-native-loop) ⭐ 58 | 🐛 4 | 🌐 Scala | 📅 2024-06-18 - Event loop and async-oriented IO for Scala Native

## Logging

* [scribe](https://github.com/outr/scribe) ⭐ 552 | 🐛 26 | 🌐 Scala | 📅 2026-08-13 - Fast and simple logging library.
* [slogging](https://github.com/jokade/slogging) ⭐ 52 | 🐛 13 | 🌐 Scala | 📅 2020-09-17 - [Typesafe-logging](https://github.com/lightbend/scala-logging) ⭐ 926 | 🐛 31 | 🌐 Scala | 📅 2026-07-31 and [SLF4J](https://www.slf4j.org/)-compatible logging library based on macros.

## Console

* [scopt](https://github.com/scopt/scopt) ⭐ 1,445 | 🐛 59 | 🌐 Scala | 📅 2026-08-12 - Command-line argument parser.
* [scallop](https://github.com/scallop/scallop) ⭐ 686 | 🐛 9 | 🌐 Scala | 📅 2025-11-30 - A simple Scala CLI parsing library.
* [decline](https://github.com/bkirwi/decline) ⭐ 679 | 🐛 34 | 🌐 Scala | 📅 2026-04-08 - A composable command-line parser for Scala.
...
* [scala-optparse-applicative](https://github.com/xuwei-k/optparse-applicative) ⭐ 16 | 🐛 1 | 🌐 Scala | 📅 2026-08-07 - Port of Haskell's CLI argument parsing library [optparse-applicative](https://hackage.haskell.org/package/optparse-applicative).
...
* [Coursier](https://github.com/coursier/coursier) ⭐ 2,132 | 🐛 475 | 🌐 Scala | 📅 2026-08-14 - Coursier's [`bootstrap` command](https://get-coursier.io/docs/cli-native-bootstrap) generates native launchers.
