...
* [Giter8 template for a minimal Scala Native project](https://github.com/scala-native/scala-native.g8) ⭐ 80 | 🐛 6 | 🌐 Scala | 📅 2026-09-14 - Official [Giter8](http://www.foundweekends.org/giter8/) template for a minimal Scala Native project.
...
* [Mill](https://github.com/com-lihaoyi/mill) ⭐ 2,791 | 🐛 271 | 🌐 Scala | 📅 2026-09-14 - Build tool striving for simplicity, inspired by [Bazel](https://www.bazel.build/).
...
* [Seed](https://github.com/tindzk/seed) ⭐ 238 | 🐛 24 | 🌐 Scala | 📅 2020-12-11 - Build tool based on Bloop. Focuses on user experience and cross-platform builds, inspired by [Cargo](https://github.com/rust-lang/cargo) ⭐ 15,477 | 🐛 1,670 | 🌐 Rust | 📅 2026-09-14.
* [sbt](https://www.scala-sbt.org/) - Scala's standard build tool.

## Functional Programming

* [Cats](https://github.com/typelevel/cats) ⭐ 5,466 | 🐛 285 | 🌐 Scala | 📅 2026-09-14 - Abstractions for functional programming in Scala.
* [scalaz](https://github.com/scalaz/scalaz) ⭐ 4,667 | 🐛 159 | 🌐 Scala | 📅 2026-09-14 - Type classes and instances for data structures.
...
* [nobox](https://github.com/xuwei-k/nobox) ⭐ 33 | 🐛 1 | 🌐 Scala | 📅 2026-09-06 - Immutable primitive array wrapper without boxing.

## Unit Tests

* [ScalaCheck](https://github.com/typelevel/scalacheck) ⭐ 1,964 | 🐛 72 | 🌐 Scala | 📅 2026-09-14 - Property-based testing for Scala.
...
* [scalaprops](https://github.com/scalaprops/scalaprops) ⭐ 282 | 🐛 13 | 🌐 Scala | 📅 2026-09-14 - Library for property-based testing.
  * [scalaprops-shapeless](https://github.com/scalaprops/scalaprops-shapeless) ⭐ 10 | 🐛 5 | 🌐 Scala | 📅 2026-09-02 - Generation of arbitrary ADT instances.
  * [scalaprops-cross-example](https://github.com/scalaprops/scalaprops-cross-example) ⭐ 4 | 🐛 1 | 🌐 Scala | 📅 2026-09-03 - Cross-platform example.
...
* [libuv](https://github.com/TimothyKlim/scala-native-libuv) ⭐ 10 | 🐛 0 | 🌐 Scala | 📅 2017-04-29 - Bindings for [libuv](https://github.com/libuv/libuv) ⭐ 27,165 | 🐛 240 | 🌐 C | 📅 2026-09-14, a library for asynchronous I/O.
...
* [argonaut](https://github.com/argonaut-io/argonaut) ⭐ 544 | 🐛 28 | 🌐 Scala | 📅 2026-09-14 - Purely functional JSON parser and library.
...
* [toml-scala](https://github.com/sparsetech/toml-scala) ⚠️ Archived - [TOML](https://github.com/toml-lang/toml) ⭐ 20,613 | 🐛 6 | 📅 2026-09-11 parser with codec derivation.
* [msgpack4z](https://github.com/msgpack4z/msgpack4z-native) ⭐ 5 | 🐛 5 | 🌐 Scala | 📅 2026-09-14 - Implementation of [MessagePack](https://msgpack.org/), a binary serialisation format.
...
* [skunk](https://github.com/typelevel/skunk) ⭐ 1,667 | 🐛 87 | 🌐 Scala | 📅 2026-09-14 -  A data access library for Scala + Postgres.
...
* [scribe](https://github.com/outr/scribe) ⭐ 553 | 🐛 30 | 🌐 Scala | 📅 2026-09-10 - Fast and simple logging library.
...
* [scala-optparse-applicative](https://github.com/xuwei-k/optparse-applicative) ⭐ 16 | 🐛 4 | 🌐 Scala | 📅 2026-09-13 - Port of Haskell's CLI argument parsing library [optparse-applicative](https://hackage.haskell.org/package/optparse-applicative).
...
* [Coursier](https://github.com/coursier/coursier) ⭐ 2,135 | 🐛 444 | 🌐 Scala | 📅 2026-09-14 - Coursier's [`bootstrap` command](https://get-coursier.io/docs/cli-native-bootstrap) generates native launchers.
